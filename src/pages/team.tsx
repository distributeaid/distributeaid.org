        ...
        <div
          ...
          >
            ...
            <h2>{memberDomain.name}</h2>
              <div>
                {"Staff" === memberDomain?.roles[0]?.role?.domain ? `${memberdata}` : 'False' }
              </div>
            </a>
            ))}
      ...
      {showVolunteers && (
        <div
          ...
          >
            ...
            <h2>{memberDomain.name}</h2>
              <div>
                {"Volunteer" === memberDomain?.roles[0]?.role?.domain ? `${memberdata}` : 'False' }
              </div>
            </a>
            ))}
...
<div className="flex justify-center items-center landscape:hidden">
      ...
      {showBoard && (
        <div
          ...
          >
            ...
            <h2>{memberDomain.name}</h2>
              <div>
                {"Board" === memberDomain?.roles[0]?.role?.domain ? `${memberdata}` : 'False' }
              </div>
            </a>
            ))}
 ...
 {/* ))} */}
      ...
      <div id="memberdata" className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 lg:px-8 py-12 lg:py-24 max-w-7xl mx-auto">
          ...
          // body={member.bio}
          >
            <h3 className="text-2xl text-gray-600 mb-4 pl-4 pr-4"><ExternalLink className="link" href={member.link}>{member.name}</ExternalLink></h3>
